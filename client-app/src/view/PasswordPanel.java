...
public class PasswordPanel extends JPanel {
	...
	private void init(String iconPath, String placeHolder) {
		...
		iconLabel.setIcon(new ImageIcon(PasswordPanel.class.getResource(iconPath)));

		txtField.setOpaque(false);
		txtField.setFont(new Font("SansSerif", Font.PLAIN, 14));
		txtField.setBorder(null);
		txtField.setColumns(10);
		passwordChar = txtField.getEchoChar();
		...
		txtField.addFocusListener(new FocusListener() {
			public void focusGained(FocusEvent e) {
				...
				if (txtField.getForeground().equals(Color.GRAY)) {
					...
					txtField.setEchoChar(passwordChar);
				}
	...
	public PasswordPanel(String iconPath, String placeHolder) {
	...
	public void setTxtField(JPasswordField txtField) {
