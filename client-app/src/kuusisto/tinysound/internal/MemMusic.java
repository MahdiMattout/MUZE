...
public class MemMusic implements Music {
	 ...
	 * @param mixer2 Mixer with which this Music is registered
	 */
	public MemMusic(byte[] left, byte[] right, Mixer mixer2) {
		this.left = left;
		this.right = right;
		this.mixer = mixer2;
	...
	public void unload() {
		...
		((kuusisto.tinysound.internal.Mixer) this.mixer).unRegisterMusicReference(this.reference);
